    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Sub Category</h1>
            </div>
         ...
         <div>    
            <!-- Main modal -->
            <div id="modal-add-sub" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0m   ax-h-full inset-0 bg-black/20 h-screen">
                @include('pages.menu.sub-category.component.add')
            </div>

            <!-- Edit Sub Category modal -->
            <div id="modal-edit-sub" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0  max-h-full inset-0 bg-black/20 h-screen">
          ...
          <x-table>
            ...
            <tr class="border-b dark:border-gray-700">
                ...
                <td class="px-4 py-3 text-end">
                    <a href="#" class="text-blue-600 hover:underline" onclick="editSub()">Edit</a>
                </td>
            </tr>
            @endfor
