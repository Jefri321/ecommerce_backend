<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
         ...
         <div>    
            <!-- Main modal -->
            <div id="modal-add-permission" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0m   ax-h-full inset-0 bg-black/20 h-screen">
                @include('pages.menagement-control.permission.component.add')
            </div>
            ...
            <div id="modal-edit-permission" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0  max-h-full inset-0 bg-black/20 h-screen">
              @include('pages.menagement-control.permission.component.edit', ['userFind' => '$userFind'])
            </div>
        ...
        <div class="">
            <x-table>
                ...
                <tr class="border-b dark:border-gray-700">
                    ...
                    <td class="px-4 py-3">Create User</td>
                    <td class="px-4 py-3 text-end cursor-pointer" onclick="editPermission(1)">Edit</td>
                </tr>
     ...
     @push('scripts')
        <script>
            ...
            let modalAddUser =  document.getElementById('modal-add-permission');
