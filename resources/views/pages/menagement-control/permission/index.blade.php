                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                <h3 id="dialog-title" class="text-base font-semibold text-gray-900">Delete Permission
                                </h3>
                                <div class="mt-2">
                    ...
                    <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                        <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                            ...
                            <button type="button" command="close" commandfor="dialog"
                                data-user-id="{{ $permission->id ?? '' }}"
                                onclick="deletePermission(this.getAttribute('data-user-id'))"
    ...
    @push('scripts')
        <script>
            ...
            function editPermission(id) {
                fetch(`/controls/permission/${id}/edit`)
                    ...
                    .then(html => {
                        ...
                        const form = modalEditContent.querySelector('#formEditPermission');
                        if (!form) return;
