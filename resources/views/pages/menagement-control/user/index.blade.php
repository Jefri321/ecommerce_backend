            ...
            <x-table>
                ...
                @foreach ($users as $i => $user)
                    <tr class="border-b dark:border-gray-700">
                        ...
                        <td class="px-4 py-3">
                            {{ !empty($user->role_names) ? implode(', ', $user->role_names) : '-' }}
                        </td>
                        <td class="px-4 py-3">
                            {{ !empty($user->permission_names) ? implode(', ', $user->permission_names) : '-' }}
                        </td>
                        <td class="px-4 py-3">
            ...
            function editUser(id) {
                fetch(`/controls/user/${id}/edit`)
                    ...
                    .then(html => {
                        ...
                        const form = modalEditContent.querySelector('#formEditUser');
                        if (!form) return;
