...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    ...
    Route::prefix('controls')->group(function () {
        ...
        Route::get('/role', function () {
            return view('pages.menagement-control.role.index');
        })->name('role');

        Route::get('/permission', function () {
            return view('pages.menagement-control.permission.index');
        })->name('permission');

         Route::get('/give-permission', function () {
            return view('pages.menagement-control.give-permission.index');
    ...
    Route::prefix('menu')->group(function () {
        ...
        Route::get('/sub-category', function () {
            return view('pages.menu.sub-category.index');
        })->name('sub-category');
    });
